...
class ExamDetailsCubit extends Cubit<ExamDetailsState> {
  ...
  void fetchStudentExamsList({required bool useParentApi,required int examStatus ,int? childId}) {
    emit(ExamDetailsFetchInProgress());
    _studentRepository
        .fetchExamsList(childId: childId ?? 0, examStatus: examStatus,useParentApi: useParentApi)
